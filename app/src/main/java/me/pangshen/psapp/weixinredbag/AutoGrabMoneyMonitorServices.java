...
public class AutoGrabMoneyMonitorServices extends AccessibilityService {
    private String TAG = "MonitorServices";
    private boolean mLuckyClicked;
    private String monkey_tag="[微信红包]";
            ...
            if (Build.VERSION.SDK_INT < 18) {
                ...
                if (null != textList && textList.size() > 0) {
                    for (String text : textList) {
                        if (!TextUtils.isEmpty(text) && text.contains(monkey_tag)) {
