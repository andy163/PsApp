...
public class ThreeFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.three_page, container, false);
    ...
    private void initRecleView(View rootView) {
        ...
        RecyclerView recyclerView = (RecyclerView) rootView.findViewById(R.id.three_page_recyclerView);
        for (int i = 0; i < 100; i++) {
            data.add("test" + i);
        }
